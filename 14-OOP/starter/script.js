...
const Person = function (firstName, birthYear) {
  ...
  // Never create a method in the constructor func
...
const arr = [3, 5, 5, 7, 6, 7, 9, 3]; // new Array === []
...
Car.prototype.accelerate = function () {
  this.speed += 10;
  consolg.log(`${this.make} is going at ${this.speed} Km/h`);
};
Car.prototype.brake = function () {
  this.speed -= 5;
  consolg.log(`${this.make} is going at ${this.speed} Km/h`);
...
// Account.test();
console.log(movements.getMovements());
